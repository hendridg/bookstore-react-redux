...
- Run this command in your OS terminal to get a copy of the project:
  ...
  ```
  https://github.com/hendridg/bookstore-react-redux
  ```
...
Open a terminal or a git bash in the desired directory and run `https://github.com/hendridg/bookstore-react-redux`
...
Feel free to check the [issues page](https://github.com/hendridg/bookstore-react-redux/issues).
